...
document.getElementById("addtocartbtn").addEventListener("click", function () {
  ...
  localStorage.setItem("matchcarddata", JSON.stringify(matchedCardData))

  let previousdata = JSON.parse(localStorage.getItem("addtocartproduct")) || []


  let newdata = [...previousdata, ...JSON.parse(localStorage.getItem("matchcarddata"))]


  localStorage.setItem("addtocartproduct", JSON.stringify(newdata))
